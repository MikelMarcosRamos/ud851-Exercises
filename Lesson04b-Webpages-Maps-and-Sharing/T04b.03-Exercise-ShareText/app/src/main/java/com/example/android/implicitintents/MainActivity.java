...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        ...
        String textoCompartido = getString(R.string.texto_compartido);

        // COMPLETED (6) Replace the Toast with shareText, passing in the String from step 5
        this.shareText(textoCompartido);
    }
    ...
    private void shareText(String textoCompartir) {
        ...
        String title = getString(R.string.titulo_texto_compartido);
