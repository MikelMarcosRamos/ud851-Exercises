...
public class MainActivity extends AppCompatActivity {
    ...
    private ProgressBar pgLoadingIndicator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pgLoadingIndicator = (ProgressBar) findViewById(R.id.pb_loading_indicator);
    }
    ...
    private void showErrorMessage(String data) {
        mErrorMessageDisplay.setText(data);
    ...
    public class GithubQueryTask extends AsyncTask<URL, Void, String> {
        ...
        protected void onPreExecute() {
            pgLoadingIndicator.setVisibility(View.VISIBLE);
        }
        ...
        protected void onPostExecute(String githubSearchResults) {
            ...
            pgLoadingIndicator.setVisibility(View.INVISIBLE);
