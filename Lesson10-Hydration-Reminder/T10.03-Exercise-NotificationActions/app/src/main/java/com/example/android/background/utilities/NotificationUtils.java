...
public class NotificationUtils {
    ...
    private static final int ACTION_INCREMENT_WATER_COUNT = 3419;
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        NotificationCompat.Action action = new NotificationCompat.Action(R.drawable.ic_cancel_black_24px, "No", pendingIntent);
    ...
    public static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getService(context, ACTION_INCREMENT_WATER_COUNT, intent, PendingIntent.FLAG_UPDATE_CURRENT);
        //      COMPLETED (15) Create an Action for the user to tell us they've had a glass of water
        NotificationCompat.Action action = new NotificationCompat.Action(R.drawable.ic_drink_notification, "Sí", pendingIntent);
