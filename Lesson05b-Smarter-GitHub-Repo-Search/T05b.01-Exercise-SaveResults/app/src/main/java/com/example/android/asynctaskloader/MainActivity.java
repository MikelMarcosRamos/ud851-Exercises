...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String KEY_TO_STORE_QUERYS = "KEY_TO_STORE_QUERYS";

    // COMPLETED (2) Create a static final key to store the search's raw JSON
    private static final String KEY_TO_STORE_SEARCHS_JSON = "KEY_TO_STORE_SEARCHS_JSON";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(KEY_TO_STORE_QUERYS)) {
                this.mUrlDisplayTextView.setText(savedInstanceState.getString(KEY_TO_STORE_QUERYS));
            }
            if (savedInstanceState.containsKey(KEY_TO_STORE_SEARCHS_JSON)) {
                this.mSearchResultsTextView.setText(savedInstanceState.getString(KEY_TO_STORE_SEARCHS_JSON));
            }
        }
    }
